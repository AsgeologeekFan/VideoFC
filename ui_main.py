...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gif_display = QLabel(self.tabWidgetPage3)
        self.gif_display.setObjectName(u"gif_display")
        self.gif_display.setGeometry(QRect(60, 100, 641, 531))
        self.gif_display.setFrameShape(QFrame.Box)
        self.gif_display.setFrameShadow(QFrame.Sunken)
        self.gif_display.setMidLineWidth(0)
        self.gif_display.setAlignment(Qt.AlignCenter)
        ...
        self.layoutWidget3.setGeometry(QRect(170, 60, 401, 26))
        ...
        self.pushButton_test = QPushButton(self.layoutWidget3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gif_display.setText(QCoreApplication.translate("MainWindow", u"GIF\u9884\u89c8\u533a", None))
        ...
        self.pushButton_test.setText(QCoreApplication.translate("MainWindow", u"\u9884\u89c8GIF", None))
